...
namespace phelosphe
{
    ...
    public class AnswerPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                e.PaintAnswerPanel(this, "#45ad11");
            }
            if (WrongAnswer == true)
            {
                e.PaintAnswerPanel(this, "#ff0000");
            }
            base.OnPaint(e);
        }
    }
    public class JokerPanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (IsUsed == true)
            {
                e.Graphics.DrawLine(new Pen(ColorTranslator.FromHtml("#ff0000"), 3), this.Width / 2 + 30, 10, this.Width / 2 - 30, this.Height);
            }
            base.OnPaint(e);
        }
    }
    public class TimePanel : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            Pen pen = new Pen(ColorTranslator.FromHtml("#fff"), 2);
            SolidBrush brush = new SolidBrush(ColorTranslator.FromHtml(this.HexCode));
            e.Graphics.SmoothingMode = SmoothingMode.AntiAlias;
            e.Graphics.DrawEllipse(pen, 5, 5, this.Width - 10, this.Height - 10);
            e.Graphics.FillEllipse(brush, 5, 5, this.Width - 10, this.Height - 10);
            base.OnPaint(e);
        }
    }
    partial class Form1
